# VidChat – YouTube RAG Chatbot 
 
Built a Retrieval-Augmented Generation (RAG) application that processes YouTube videos by extracting transcripts, chunking content, and storing embeddings in a vector database for semantic search.
